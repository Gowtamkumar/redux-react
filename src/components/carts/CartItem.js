...
import { removeItems, increment } from '../../store1/features/cart/Cart';
            ...
            <div className='col-md-3' key={index}>
              <div className="card" style={{ width: '18rem' }}>
                ...
                <div className="card-body">
                  ...
                  <button className='btn btn-primary btn-sm ml-4' onClick={() => removeCart(singleCartItems.id)}>Remove Item</button>
